...
public class AroundStores extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_around_stores);
        Next_btn = findViewById(R.id.Next_btn);
        Next_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AroundStores.this,DeliveryItems.class));
            }
        });
